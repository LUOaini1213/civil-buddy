...
- **范围**：施工批次 **REDACTED-CODE-VMU-0001**，目的地 **工地**，有剩余量（未到货>0 或 已到货在库）
...
| REDACTED-CODE-VMU-0001-REDACTED-REF | 13—铁件 | 67 | 1998 |
...
1. 件数→当量箱：铁件约 35 件/架、铝板约 25 片/架、紧固件约 200 件/箱等（实务粗算）。
