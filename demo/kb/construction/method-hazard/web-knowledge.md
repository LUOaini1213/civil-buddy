...
辖区：用户 pack；未给则新加坡工地默认 SG。37 号令永远标 CN，禁止当 SG。本页不是规范全文库。

## CN
- 全称：《危险性较大的分部分项工程安全管理规定》，住建部令第 37 号，2018-03-08 公布、2018-06-01 施行。适用范围：房屋建筑和市政基础设施工程中的危大安全管理。济南住建转载全文（页标 2024-09-26）：https://jncc.jinan.gov.cn/col116284/art/2024/art_116284_4780280.html
- 配套公开文件只写全名：建办质〔2018〕31 号《关于实施〈危险性较大的分部分项工程安全管理规定〉有关问题的通知》。省级可补充范围。只标 CN。
- 住建部门户：https://www.mohurd.gov.cn/

公开口径：危大是施工过程中容易导致人员群死群伤或造成重大经济损失的分部分项。危大及超过一定规模的范围由国务院住建主管部门制定；省级可补充。施工前编专项方案；超规模组织专家论证；实施前方案交底 + 安全技术交底；现场公告名称/时间/责任人并设警示；不得擅自改方案。规模数字以用户尺寸 + 31 号附件/省细则原文为准。无深度/跨度/高度/荷载 → 是/否/信息不足，不猜。本岗不宣布「可以开挖」。

## SG
- 新加坡没有 37 号令名录，不要把作业写成「属于危大 / 应当专家论证」。
...
- BCA 管建筑控制与结构许可，不管「是否超危论证」。Building Control Act 页更 2026-04-30。https://www1.bca.gov.sg/safety-and-standards/building-control-act/

## 通用
禁令：禁止写「SG 工程属于 37 号令危大 / 应当专家论证后开工」。禁止把 31 号附件或地方细则里的基坑深度/跨度数字套到新加坡工地。本岗不宣布 PTW 已具备、RA 已合格、可以开挖、报审通过。DUAL 必须分栏。
