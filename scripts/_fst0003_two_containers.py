#!/usr/bin/env python3
"""Confirm REDACTED-REF site packing is already 2 cabinets in shipped loading lists."""
from pathlib import Path
import openpyxl

p = Path(
    r"A:\JOB\REDACTED-JOB\Project\6. Quality QAQC\6.06 POR\已发货"
    r"\REDACTED-DOCREF REDACTED-PROJECT 铁件(1)(1)(2).xlsx"
)
