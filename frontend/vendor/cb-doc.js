/* Civil Buddy 文书预览组件 · ux(round4) —— :8000 侧副本。
 * canonical 源文件：demo/static/docpreview.js（两端同构，改动请同步两份）。
 * 依赖：marked（frontend/vendor/marked.min.js，MIT，vendored 同源）。零 CDN。
 */
