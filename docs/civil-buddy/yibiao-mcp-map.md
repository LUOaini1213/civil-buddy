...
| 专家独有 | 仅该 `expert_id` | 65 名专家均有独有写入器；同大类兄弟看不见。施工另有 `construction__scheme_draft` + `construction__fill_scheme_docx` |
...
65 份专家 `web-knowledge.md` + 16 份大类 `_shared` + `company/web-portals.md` 已在 **2026-08-14 联网过两遍**。现场抽出：APPBCA-2026-12（2026-10-01 CORENET X 仅 GFA≥5,000 m²）、SCDF Fire Code 2023、PUB COP（排水 Add.3 / 污水 2025-09-01 / 海岸 2028）、CONQUAS 2022 + Private Residential、IRAS GST 页述 9%、SAC CE 001、SOP Act 页更 2026-08-05。
