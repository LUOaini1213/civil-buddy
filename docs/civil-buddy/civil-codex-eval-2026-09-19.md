...
| 全屏 TUI、原生 App、IDE 商店扩展、Cloud | 无 | **不做 / 缺口**（未变） |
...
4. 系统级沙箱已做（Linux、Windows；macOS 没做，读取不受限，Windows 不断网——见 os-sandbox.md）。Plugins 已做（声明式，见 plugins.md）。原生 App 见后续条目；商店扩展、Cloud 不做。
