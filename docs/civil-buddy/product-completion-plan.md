...
当前已达到：bid-parse / bid-compliance / bid-tech / pack-ship / construction 十一章 md + T001 目录闸 + T021 pack 隔离 + T023 跨大类 kb 拒绝。下一优先按 product-plan §15：T003 → T002 危大判定书。
...
全量任务号见 [product-plan.md](product-plan.md) §15。切片下一刀是 **T003**（eval/live 读 company 页）。T023 已 ✅。
