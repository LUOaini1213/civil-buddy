...
当前已达到：… + T030–T036。下一优先按 product-plan §15：**T037 · proc-plan**（T037 其余岗与 T038–T047 不得一行勾完）。
...
全量任务号见 [product-plan.md](product-plan.md) §15。切片下一刀是 **T037 · proc-plan**。T036 ✅。T037 其余岗不得一行勾完。
