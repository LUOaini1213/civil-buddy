...
当前已达到：… + T030–T033。下一优先按 product-plan §15：**T034 · supervision**（T034 与 T035–T047 不得一行勾完）。
...
全量任务号见 [product-plan.md](product-plan.md) §15。切片下一刀是 **T034 · supervision**。T033 ✅。T034 起不得一行勾完。
