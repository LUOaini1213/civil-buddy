...
当前已达到：… + T030 / T031 + T032 plan-master / plan-lookahead。下一优先按 product-plan §15：**T032 · plan-resource**（T032 其余岗与 T033–T047 不得一行勾完）。
...
全量任务号见 [product-plan.md](product-plan.md) §15。切片下一刀是 **T032 · plan-resource**。plan-lookahead ✅。T032 其余岗不得一行勾完。
