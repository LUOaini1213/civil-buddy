...
当前已达到：… + T030 survey/dispatch + T031 commercial 四岗。下一优先按 product-plan §15：**T032 · plan-master**（T032–T047 不得一行勾完）。
...
全量任务号见 [product-plan.md](product-plan.md) §15。切片下一刀是 **T032 · plan-master**。T031 ✅。T032–T047 不得一行勾完。
