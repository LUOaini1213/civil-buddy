...
当前已达到：… + T030 / T031 / T032 + T033 lab-mix / lab-sample。下一优先按 product-plan §15：**T033 · lab-record**（T033 其余岗与 T034–T047 不得一行勾完）。
...
全量任务号见 [product-plan.md](product-plan.md) §15。切片下一刀是 **T033 · lab-record**。lab-sample ✅。T033 其余岗不得一行勾完。
