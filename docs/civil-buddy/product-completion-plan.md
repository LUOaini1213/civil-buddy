...
当前已达到：… + T030–T039 + T064–T068 作业根/本机窗/可下载试用。下一优先按 product-plan §15：**T040 · hr-recruit**（T040 其余岗与 T041–T047 不得一行勾完）。
...
全量任务号见 [product-plan.md](product-plan.md) §15。切片下一刀是 **T040 · hr-recruit**。T039 pm-daily ✅。T040 其余岗不得一行勾完。
