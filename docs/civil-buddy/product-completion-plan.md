...
当前已达到：… + T030 survey/dispatch + T031 variation/claim/subcontract。下一优先按 product-plan §15：**T031 · interim**（T032–T047 不得一行勾完）。
...
全量任务号见 [product-plan.md](product-plan.md) §15。切片下一刀是 **T031 · interim**。variation / claim / subcontract ✅。T031 其余岗不得一行勾完。
